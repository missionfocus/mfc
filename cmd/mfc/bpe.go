...
const bpeVelocityExample = `
    mfc bpe velocity <milestone>		# Generate documentation for mfc in markdown format
 	mfc bpe velocity "GDAC 18"  		# Gets the velocity for the GDAC 18 milestone`
